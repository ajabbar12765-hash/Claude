...
//
// Optional: put your deployed app URL here so tapping the widget opens the app.
const APP_URL = "";
...
function wordOfDay() {
  ...
  const w = WORDS[((dayNum % WORDS.length) + WORDS.length) % WORDS.length];
  return { word: w[0], ipa: w[1], pos: w[2], def: w[3], simple: w[4], ex: w[5] };
}
