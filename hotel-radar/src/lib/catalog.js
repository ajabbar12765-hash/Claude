...
export const DESTINATIONS = [
  ...
  },
  {
    ...
    landmarks: [
      ...
      { name: 'Linate Airport', aliases: ['lin', 'linate'], lat: 45.4451, lng: 9.2767 },
      { name: 'Bocconi University', aliases: ['bocconi', 'universita bocconi', 'sda bocconi'], lat: 45.4478, lng: 9.1885 },
      { name: 'Politecnico di Milano', aliases: ['politecnico', 'polimi'], lat: 45.4787, lng: 9.2272 },
      { name: 'Universita Statale', aliases: ['statale', 'university of milan'], lat: 45.4614, lng: 9.1946 },
      { name: 'Universita Cattolica', aliases: ['cattolica'], lat: 45.464, lng: 9.177 },
      { name: 'Fiera Milano Rho', aliases: ['rho fiera', 'fiera milano', 'fieramilano'], lat: 45.5178, lng: 9.0855 },
      { name: 'Porta Romana', aliases: [], lat: 45.4494, lng: 9.2044 },
      { name: 'Isola', aliases: ['isola district'], lat: 45.4869, lng: 9.1877 },
      { name: 'Corso Buenos Aires', aliases: ['porta venezia'], lat: 45.4795, lng: 9.2103 },
    ],
    hotels: [
      ...
      h('Grand Visconti Palace', 'Porta Romana', 4, 8.7, 3410, 190, 45.4432, 9.2065, 'spa restaurant bar wifi gym parking aircon familyfriendly', 'Former mill with a large private garden, walkable to Bocconi.'),
      h('UNAHOTELS Mediterraneo Milano', 'Porta Romana', 4, 8.5, 2870, 165, 45.4525, 9.2098, 'restaurant bar wifi gym aircon parking', 'Steps from Porta Romana metro, a short ride to the Duomo.'),
      h('Petit Palais Hotel de Charme', 'Ticinese', 4, 9.0, 890, 210, 45.4569, 9.1836, 'wifi breakfast bar aircon petfriendly', 'Quiet residence near the Colonne di San Lorenzo and the canals.'),
    ],
  },
  {
    id: 'rome',
