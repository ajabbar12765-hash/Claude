# WhatsApp Sales Script — Food by Punjabi Restaurant
...
## Why this business closes

| Signal | Value | Why it matters in the pitch |
|---|---|---|
| Rating | 4.8 ★ | He is proud of it. Lead with the number. |
| Reviews | 1,073 (946 are 5-star) | Proven demand. He is not struggling for customers — he is struggling for *reach*. |
| Website | **None** | The entire gap. |
| Google photos | 538 | Customers are doing his marketing. He'll get the point instantly. |
| Reviews in 5 languages | English, Russian, Spanish, Polish, French | Heavy tourist trade. Tourists Google a restaurant before walking in. No website = they scroll past. |
...
## Message 2 — after he opens it (send only once he replies)
...
>
> AED 750 to start, AED 750 when it's live. Works for you?

*Splitting the payment removes the last hesitation. Never ask for the full amount upfront on a cold WhatsApp deal.*

---

## Objection handling

**"I don't need a website, I'm always full."**
> You're full at 9 PM. I looked at your Google traffic — Monday to Thursday before 2 PM you're at about 10% capacity. That's the money the website goes after, not the dinner rush.

**"It's too expensive."**
> I understand. What's your average bill — 40 dirhams? So this is 35 covers, once. If it brings you one extra table a week it pays for itself in a month and then it's free forever. And I'll split it: half now, half when it's live.

**"Talabat/Deliveroo already brings me orders."**
> They do, and they take 25–30% of each one. This site sends people straight to your WhatsApp — that order costs you nothing. Keep the apps, but stop paying commission on customers who already know your name.

**"My nephew/cousin can make one."**
> Maybe. Ask him how long. I already finished yours — you're looking at it. And I'll be here in 6 months when you want the menu changed.
...
## Follow-up sequence — if he goes quiet

| When | Message |
|---|---|
| **Day 2** | Assalam alaikum Harpreet ji — did the link open properly on your phone? Sometimes WhatsApp blocks it. Here it is again: [LINK] |
...
## Reusable template — leads #2 to #25

Swap the bracketed parts from `leads/dubai-restaurants-no-website.csv`:
...
- Always name the real rating and review count — that one detail is what stops the scroll.
- Send between 2:30 and 4:30 PM. Never during dinner service.
- If they don't reply twice, stop.

---

## Before you send anything

- **Deploy the site and get a real URL first.** The link is the whole pitch. `demo-sites/food-by-punjabi/index.html` is a single self-contained file — drop it on Netlify Drop, Vercel, or GitHub Pages and you have a link in two minutes.
